...
public class DeleteFromQuantitesQueryHandeler : IRequestHandler<DeleteFromQuantitesQuery, IEnumerable<ItemQuantityDTO>>
{
    private readonly IMediator _mediator;
    public AppDbContext _dbContext { set; get; }
    public DeleteFromQuantitesQueryHandeler(AppDbContext dbContext, IMediator mediator)
    {
    ...
    public async Task<IEnumerable<ItemQuantityDTO>> Handle(DeleteFromQuantitesQuery request, CancellationToken cancellationToken)
    {
        ...
        foreach (var item in items)
        {
            ...
            quantites.Remove(itemQuantityDTO);
